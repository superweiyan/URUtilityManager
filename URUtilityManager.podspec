#
#  Be sure to run `pod spec lint URUtilityManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  private tools set, no promise all it right
                   DESC

  s.homepage     = "https://github.com/superweiyan/URUtilityManager.git"
  ...
  s.author             = { "superweiyan" => "superweiyan@163.com" }
